...
public class ParkingService {
    ...
    public void processExitingVehicle() {
        try {
            ...
            // > 1 car le ticket en cours est déjà sauvegardé en BDD
            ...
            if (ticketDAO.updateTicket(ticket)) {
                ...
                if (ticketDAO.getNbTicket(vehicleRegNumber) > 1) {
                    System.out.println("Thanks for being a loyal customer" + ticket.getVehicleRegNumber() + " your price was discounted to:" + ticket.getPrice());
                } else {
